...
test('UEFA Gaming smoke test', async ({ page }) => {
    await page.goto('https://www.uefa.com/uefaconferenceleague/games/');

    await page.getByRole('button', { name: '✓Accept all' }).click();

    await page.getByRole('link', { name: 'Conference League Predict Six!' }).click();
    ...
    await expect(page).toHaveURL(/.*ueclpredictor.*/);
});